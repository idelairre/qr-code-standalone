...
interface IconPickerProps {
   ...
   onSelectIcon: (
      iconName: string,
      iconComponent: React.ComponentType<unknown> | React.ReactElement,
   ) => void;
   selectedIcon?: string;
}
...
const useVirtualScroll = (
   ...
   const endRow = Math.min(startRow + Math.ceil(actualHeight / rowHeight) + 1, totalRows);
                  ...
                  <Dialog.Body p={0} flex="1" overflow="hidden">
                     <VStack gap={0} h="full" overflow="hidden">
                        ...
                        <Box flex="1" w="full" overflow="hidden" minH={0}>
                           ...
                           >
                              <Box position="relative" height={`${totalHeight}px`} p={4} w="full">
                                 <Grid
                                    ...
                                    {visibleItems.map((icon) => {
                                       ...
                                       return (
                                          <Button
                                             ...
                                             minH="60px"
                                             onClick={() =>
                                                handleIconSelect(icon.name, icon.component)
                                             }
