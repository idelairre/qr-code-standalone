                  ...
                  <Dialog.Body>
                     <VStack gap={6} align="stretch">
                        <Text color={subtextColor} fontSize="sm">
                           Adjust these settings to control how your PNG image is converted to SVG
                           format.
                        </Text>
                           ...
                           <HStack justify="space-between" align="center">
                              ...
                              <Switch.Root
                                 ...
                                 onCheckedChange={(details) =>
                                    handleOptionChange("optCurve", details.checked)
                                 }
                                 size="lg"
                              >
                                 <Switch.Thumb />
                        ...
                        <Field.Root>
                           ...
                           <ColorPicker.Root
                              ...
                              onValueChange={(details) =>
                                 handleOptionChange("color", details.value.toString("hex"))
                              }
                              w="full"
                           >
                           ...
                           <Field.HelperText>Color used for the SVG paths</Field.HelperText>
                        </Field.Root>
                        ...
                        <Field.Root>
                           ...
                           <Slider.Root
                              ...
                              onValueChange={(details) =>
                                 handleOptionChange("optTolerance", details.value[0])
                              }
                              min={0}
                              max={1}
                              step={0.1}
                           ...
                           <Field.HelperText>Higher values = smoother curves</Field.HelperText>
                        </Field.Root>
                        ...
                        <Field.Root>
                           ...
                           <Slider.Root
                              ...
                              onValueChange={(details) =>
                                 handleOptionChange("speckleSize", details.value[0])
                              }
                              min={0}
                              max={10}
                              step={1}
                           ...
                           <Field.HelperText>Remove small details below this size</Field.HelperText>
                        </Field.Root>
                     </VStack>
                  </Dialog.Body>
